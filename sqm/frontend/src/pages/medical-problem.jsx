...
const MedicalProblem = () => {
  ...
  const handleSubmit = () => {
    ...
    if (!problem || problem.trim() === '') {
      alert('Please select or enter your medical problem');
      return;
    }
    ...
    <section className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24">
        ...
        <motion.div
          ...
          className="bg-white rounded-xl -mx-20 shadow-sm border border-gray-200 p-6 mb-8"
        >
          {/* Search Bar */}
          <div className="flex gap-4 mb-6">
            <div className="flex-1 relative">
              <input
                ...
                placeholder="Search diseases, symptoms, or specialists (e.g., 'heart', 'cardiologist', 'eye')..."
          ...
          <div className="flex justify-center mt-6">
            <motion.button
              ...
              className="px-8 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors shadow-md hover:shadow-lg disabled:bg-gray-400 disabled:cursor-not-allowed"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
