  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-35">
        ...
        >
          <motion.div 
            className="bg-white p-10 z-10 rounded-3xl shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300"
          ...
          <motion.div 
            className="bg-white p-10 rounded-3xl z-10 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300"
            variants={itemVariants}
            whileHover={{ scale: 1.02 }}
            transition={{ duration: 0.2 }}
          >
